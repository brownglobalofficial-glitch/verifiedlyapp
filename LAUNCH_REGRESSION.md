...
| Custom domain registration | 🗑 Removed | The Name.com reseller integration has been removed. Creators who want a custom domain should connect one through Lovable's built-in custom-domain flow (Project Settings → Domains). |
...
- The Name.com reseller integration has been removed from the product.
  Custom domains are handled by Lovable's native custom-domain flow.
