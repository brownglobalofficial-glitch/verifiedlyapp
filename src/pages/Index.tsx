  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6 py-10 font-sans">
      <Helmet>
        ...
        <meta name="description" content="Create an official profile, optionally verify your identity, and use one secure account across connected apps." />
      ...
      <main className="w-full max-w-sm flex flex-col items-center">
        ...
        <div className="text-center mb-9 max-w-[330px]">
          ...
          <p className="mt-3 text-sm sm:text-base text-muted-foreground leading-relaxed">
            Create your profile in about a minute, add the details you choose, and use Verifiedly to sign in to connected GSN, Globalis, and BrownGlobal services.
          </p>
        </div>
        ...
        <div className="mb-8 grid w-full grid-cols-3 gap-2 text-center">
          <div className="rounded-2xl border border-border p-3">
            ...
            <p className="mt-1 text-[10px] text-muted-foreground">Official profile</p>
          </div>
          <div className="rounded-2xl border border-border p-3">
            <p className="text-xs font-semibold">Verify</p>
            <p className="mt-1 text-[10px] text-muted-foreground">Optional identity</p>
          </div>
          <div className="rounded-2xl border border-border p-3">
            <p className="text-xs font-semibold">Connect</p>
            <p className="mt-1 text-[10px] text-muted-foreground">Approved apps</p>
          </div>
        </div>
        ...
        <div className="w-full space-y-3">
          ...
          <Link to="/login" className="flex items-center justify-center w-full bg-transparent border-2 border-foreground text-foreground py-4 px-8 text-xs font-bold uppercase tracking-widest transition-all hover:bg-foreground hover:text-background">
            Sign in
          </Link>
        </div>

        <p className="mt-6 flex items-center justify-center gap-1.5 text-center text-[11px] text-muted-foreground leading-relaxed max-w-[315px]">
          <ShieldCheck className="h-3.5 w-3.5 shrink-0" /> Apps receive only the account information you approve.
        </p>
