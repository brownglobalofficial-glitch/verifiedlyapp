...
const Refunds = () => (
  <div className="min-h-screen overflow-x-hidden bg-background px-4 py-12">
    ...
    <div className="prose prose-sm mx-auto max-w-3xl break-words dark:prose-invert">
      ...
      <p>A Tap Card pre-order is charged when Stripe Checkout confirms payment. It is then placed in BrownGlobal's manual review and supplier-fulfillment queue. A paid pre-order is not the same as a shipped order.</p>
